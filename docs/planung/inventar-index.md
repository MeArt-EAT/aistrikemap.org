...
| 94–99 | Phase 2 – AI Career Impact Dashboard | [phase-2-career-dashboard.md](phase-2-career-dashboard.md) · Punkt 1 (Datenquellen): [career-dashboard-datenquellen-matrix.md](career-dashboard-datenquellen-matrix.md) · Punkt 2 (Score-Methodik): [career-dashboard-score-methodik.md](career-dashboard-score-methodik.md) · Punkt 3 (UX/UI): [career-dashboard-ux-konzept.md](career-dashboard-ux-konzept.md) · Punkt 4 (Bias-Transparency): [career-dashboard-bias-transparency.md](career-dashboard-bias-transparency.md) · Punkt 5 (Recht): [career-dashboard-recht.md](career-dashboard-recht.md) | Idee · Konzeptphase Punkt 1–5 entschieden |
...
| Gegenwart | AI Live-Radar | 100–103 |
| Zukunft | AI Career Impact Dashboard | 94–99 |
