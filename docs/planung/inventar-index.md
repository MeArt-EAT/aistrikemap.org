...
| **105** | Phase 2 – Labor-Impact-Cases (Datenbank konkreter KI-bedingter Stellen-Veränderungen) | [phase-2-labor-impact-cases.md](phase-2-labor-impact-cases.md) · Schema v0.2: [data/labor-impact-cases/_schema.md](../../data/labor-impact-cases/_schema.md) · Bundle: [scripts/bundle-labor-cases.js](../../scripts/bundle-labor-cases.js) | **Live 2026-05-01/02** · 4 Cases (SAP DE 10k, IBM US 7,8k, Klarna SE 700, Amazon US 14k) = 32.500 in 3 Ländern · Schema-Erweiterung tags/severity_class/last_verified · Pro-Land-Bundle-Splitting in `data/labor-impact-by-country/` aktiv · Aggregate enthält by_country/by_industry/by_tag/by_severity/country_files-Manifest |
