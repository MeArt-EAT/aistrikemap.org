...
| ➡️ **Nächster Schritt** | **Quellen-Offensive fortsetzen: Welle 3 ff.** Welle 1 (2026-09-26, 12 Files: alle Sev-5 + 1 Sev-4) und Welle 2 (12 Sev-4) erledigt - in **24 von 24** Files echte Fehler, u.a. erfundene Berichte (Amnesty 'Fatal Failures'), erfundene Zitate, erfundene Zahlen ('5.000 Telegram-Kanäle'), erfundene Folgen (EU-Vertragsverletzungsverfahren, EDPB-Leitlinie), ein nicht existierendes System ('TOSCA'). **Noch 65 Timelines ganz ohne Quellen** (35 Sev-4, 29 Sev-3, 1 Sev-2), 844/10.957 TL-Einträge quellenlos. **Offene Entscheidungen für den Projekteigner:** (1) Namen, die über die Belege hinausgehen: pakistan-blasphemie ('KI-Überwachung' unbelegt - gehört der Fall überhaupt in die DB?), irak-zello ('KI zur Zielerfassung'), belarus ('SORM-Überwachung'), china-hui, china-kirchen ('Pflicht für alle'), unesco (Erfindung beiden Chatbots zugeschrieben), daenemark-amnesty-bericht-60 ('60+' statt 'bis zu 60'), daenemark-kinderschutz ('Fehlerquote'); (2) Slug emirate-tosca ('TOSCA' existiert nicht); (3) **Dubletten:** 3 Dänemark-Files beschreiben denselben Amnesty-Bericht (13.11.2024): daenemark-amnesty-bericht-60-…, daenemark-amnesty-zeigt-…, daenemark-udbetaling-danmark-bis-zu-60-… - zusammenlegen? |
