...
const FIX_MAP = {
  ...
  // Batch ergaenzt 2026-06-18 (TL Sev-4 Welle-Schluss): deutsche Woerter, die
  // in TL-Texten transliteriert auftraten. Nur eindeutige ae/oe/ue — ss-Woerter
  // wie dass/sodass/Messer/Vorwissen sind korrekt und NICHT enthalten.
  'schueler': 'schüler',
  'mitschueler': 'mitschüler',
  'mitschuelern': 'mitschülern',
  'achtklaessler': 'achtklässler',
  'uebersah': 'übersah',
  'eingefuehrt': 'eingeführt',
  'gegruendete': 'gegründete',
  'gestuetzt': 'gestützt',
  'gestuetzte': 'gestützte',
  'gestuetztes': 'gestütztes',
  'gestuetzten': 'gestützten',
  ...
  'herkoemmliche': 'herkömmliche',
  'herkoemmlichen': 'herkömmlichen',
  'gegenstaende': 'gegenstände',
  'gegenstaenden': 'gegenständen',
  ...
  'leistungsfaehige': 'leistungsfähige',
  'leistungsfaehiger': 'leistungsfähiger',
  'gefaelschtes': 'gefälschtes',
  'gefaelschten': 'gefälschten',
  'gefaelschte': 'gefälschte',
  'gefaelscht': 'gefälscht',
  'spaeteren': 'späteren',
  'spaetere': 'spätere',
  'vorsaetzlich': 'vorsätzlich',
  'vorsaetzliche': 'vorsätzliche',
  'boeswillig': 'böswillig',
  'boeswillige': 'böswillige',
  'veraenderter': 'veränderter',
  'veraenderte': 'veränderte',
  'koerper': 'körper',
  'verfuegten': 'verfügten',
  'verfuegbarkeit': 'verfügbarkeit',
  'belaestigungs': 'belästigungs',
  'praegte': 'prägte',
  'fuehrte': 'führte',
  'maengel': 'mängel',
  'minderjaehrige': 'minderjährige',
  'minderjaehriger': 'minderjähriger',
  'minderjaehrigen': 'minderjährigen',
  'jaehriger': 'jähriger',
  'jaehriges': 'jähriges',
